...
class Hierarchy(tfutils.Module):
    def __init__(self, wm, act_space, config):
        ...
        self.worker = agent_torch.ImagActorCritic({
            'extr': agent_torch.VFunction(lambda s: s['reward_extr'], wconfig),
            'expl': agent_torch.VFunction(lambda s: s['reward_expl'], wconfig),
            'goal': agent_torch.VFunction(lambda s: s['reward_goal'], wconfig),
